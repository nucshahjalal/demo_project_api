        ...
        <div class="container bg-white border-start border-end py-3">
            <div id="schoolHeroSlider" class="carousel slide carousel-fade shadow-sm rounded border border-light overflow-hidden" data-bs-ride="carousel" data-bs-wrap="true" data-bs-pause="false">
                ...
                <div class="carousel-inner" style="max-height: 400px;">
                    ...
                    <div class="carousel-item" data-bs-interval="4000">
                        <img src="https://images.unsplash.com/photo-1441339907198-e08756dedf3f?w=1200&auto=format&fit=crop&q=80" class="d-block w-100 img-fluid object-fit-cover" style="min-height: 250px; height: 400px;" alt="মাদ্রাসা ভবন">
                        <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-2">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li class="py-2 border-bottom d-flex justify-content-between align-items-center">
                                            <a href="#" class="text-decoration-none text-dark fw-bold" data-bs-toggle="modal" data-bs-target="#allDataModal">
                                                <i class="bi bi-caret-right-fill text-danger small"></i> বাতাইছড়ি দাখিল মাদ্রাসা নোটিশ নোটিফিকেশন বুক।
                                            </a>
                                            <span class="badge bg-secondary p-2" data-bs-toggle="modal" data-bs-target="#allDataModal" style="cursor: pointer;">সকল</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4 border border-light shadow-sm">
                        <div class="row w-100 m-0">
                            <div class="col-12 card-header bg-custom-blue text-white fw-bold py-3 px-4 rounded-0 w-100">
                                <i class="bi bi-people-fill me-2"></i> কৃতি শিক্ষার্থী তালিকা (দাখিল ষষ্ঠ শ্রেণী)
                            </div>
                        </div>
                        <div class="card-body bg-light bg-opacity-25">
                            <div class="row g-3 row-cols-1 row-cols-sm-2 row-cols-md-4 w-100 mx-0">
                                ...
                                <div class="col">
                                    <div class="student-card h-100 border rounded p-3 text-center bg-white shadow-sm">
                                        <div class="student-img-container mb-3">
                                            <img src="https://placehold.co/150x150/png" alt="জাকিয়া মারজান" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                        </div>
                                        <div class="student-details">
                                            <h5 class="student-name fw-bold mb-1">জাকিয়া মারজান</h5>
                                            <div class="student-class text-muted small mb-2">দাখিল ষষ্ঠ</div>
                                            <div class="student-meta badge bg-secondary me-1">Roll: 1</div>
                                            <div class="student-meta badge bg-light text-dark border">Reg: 1134</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="student-card h-100 border rounded p-3 text-center bg-white shadow-sm">
                                        <div class="student-img-container mb-3">
                                            <img src="https://placehold.co/150x150/png" alt="মাহমুদুল ইসলাম সাইফ" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                        </div>
                                        <div class="student-details">
                                            <h5 class="student-name fw-bold mb-1">মাহমুদুল ইসলাম সাইফ</h5>
                                            <div class="student-class text-muted small mb-2">দাখিল ষষ্ঠ</div>
                                            <div class="student-meta badge bg-secondary me-1">Roll: 2</div>
                                            <div class="student-meta badge bg-light text-dark border">Reg: 1135</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="student-card h-100 border rounded p-3 text-center bg-white shadow-sm">
                                        <div class="student-img-container mb-3">
                                            <img src="https://placehold.co/150x150/png" alt="ফারিয়া আক্তার" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                        </div>
                                        <div class="student-details">
                                            <h5 class="student-name fw-bold mb-1">ফারিয়া আক্তার</h5>
                                            <div class="student-class text-muted small mb-2">দাখিল ষষ্ঠ</div>
                                            <div class="student-meta badge bg-secondary me-1">Roll: 3</div>
                                            <div class="student-meta badge bg-light text-dark border">Reg: 1136</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="student-card h-100 border rounded p-3 text-center bg-white shadow-sm">
                                        <div class="student-img-container mb-3">
                                            <img src="https://placehold.co/150x150/png" alt="উম্মে বাসিরাতুন অহি" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                        </div>
                                        <div class="student-details">
                                            <h5 class="student-name fw-bold mb-1">উম্মে বাসিরাতুন অহি</h5>
                                            <div class="student-class text-muted small mb-2">দাখিল ষষ্ঠ</div>
                                            <div class="student-meta badge bg-secondary me-1">Roll: 4</div>
                                            <div class="student-meta badge bg-light text-dark border">Reg: 1289</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>২০/০৫/২০২৬</td>
                                    <td>অর্ধ-বার্ষিক পরীক্ষা সময়সূচী ও নিয়মাবলী</td>
                                    <td><span class="badge bg-success">সাধারণ</span></td>
                                </tr>
                                <tr>
                                    <td>১৮/০৫/২০২৬</td>
                                    <td>দাখিল ষষ্ঠ শ্রেণীর কৃতি শিক্ষার্থীদের সংবর্ধনা অনুষ্ঠান</td>
                                    <td><span class="badge bg-primary">দাখিল</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
